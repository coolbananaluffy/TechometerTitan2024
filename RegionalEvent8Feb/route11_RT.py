...
async def main():
    ...
    await motor.run_for_degrees(REARATTACHMENTPORT,50,500)
    ...
    await motor_pair.move_tank_for_degrees(0,convertcmToDegree(63.5), 500, 500)
    ...
    await motor_pair.move_tank_for_degrees(0, turnDegree(-49), 200, -200)
    ...
    await motor.run_for_degrees(REARATTACHMENTPORT,-60,1000)
