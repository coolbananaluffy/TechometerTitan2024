...
async def main():
   ...
   # await leftGyro(220, motor_pair.PAIR_1)
    ...
    await rightGyro(-60, motor_pair.PAIR_1)
    await motor_pair.move_tank_for_degrees(0, convertcmToDegree(2), 500 , 500)
    await motor.run_for_degrees(FRONTATTACMENTPORT,30,1000)
    await motor.run_for_degrees(FRONTATTACMENTPORT,-50,1000)
    ...
    await motor_pair.move_tank_for_degrees(0, convertcmToDegree(-5), 500 , 500)
    await leftGyro(650, motor_pair.PAIR_1)
    await motor.run_for_degrees(FRONTATTACMENTPORT, -200 , 1000)
    await motor_pair.move_tank_for_degrees(0, convertcmToDegree(5), 500 , 500)
    await motor.run_for_degrees(FRONTATTACMENTPORT, 200 , 1000)
 ...
 #   await motor_pair.move_tank_for_degrees(0, convertcmToDegree(6),200 , 200)
   # await motor_pair.move_tank_for_degrees(0, convertcmToDegree(-6),200 , 200)
  #  await motor.run_for_degrees(FRONTATTACMENTPORT,200,200)
