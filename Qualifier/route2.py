...
async def main():
  ...
  #  await motor_pair.move_tank_for_degrees(0, convertcmToDegree(-5),800 , 800)
    ...
    #Left 1 degree
#Drop attachement
  #  await motor.run_for_degrees(REARATTACHMENTPORT,-120,200)
    await rightGyro(-50, motor_pair.PAIR_1)
    await motor_pair.move_tank_for_degrees(0, convertcmToDegree(-45),1000 , 1000)
